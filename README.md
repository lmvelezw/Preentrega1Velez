# La Relojería E-commerce
Proyecto de ecommerce básico para el curso de React de Coderhouse. La aplicación permite utilizar una lista de relojes para realizar compras en línea. Los productos y las órdenes de compra se almacenan en Firebase.

## Tecnologías utilizadas
- Create React App
- React
- React Router
- Firebase para almacenar productos y ordenes de compra
- Tailwind CSS para dar estilo
- Toastify para popups informativos
